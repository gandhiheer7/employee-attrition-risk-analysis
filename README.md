...
> Predicting which employees are at risk of leaving — before they resign — using classification models on real HR data, with a Power BI dashboard for HR decision-making.
...
**Dataset:** IBM HR Analytics Employee Attrition & Performance — 1,470 real (anonymized) employee records.
...
- Feature-direction chart showing which factors increase vs. decrease risk
